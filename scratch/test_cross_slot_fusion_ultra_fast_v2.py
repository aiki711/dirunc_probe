...
def main():
    ...
    parser.add_argument("--sub_size", type=int, default=1000, help="Subset size for CV and Fusion")
    ...
    # Subsample training data subset for rapid CV & Fusion fitting
    np.random.seed(42)
    ...
    # -----------------------------------------------------------------------
    # Setup A: Baseline (L2 Logistic Regression, single-threaded, fast convergence)
    # -----------------------------------------------------------------------
    ...
    for d in range(7):
        ...
        # Fast 5-fold CV on subsampled subset
    ...
    # -----------------------------------------------------------------------
    print("\n" + "="*70)
    print(" CROSS-SLOT FEATURE FUSION EVALUATION RESULTS (FAST V2 - L2) ")
    print("="*70)
