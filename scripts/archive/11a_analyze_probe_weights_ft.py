...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="runs/balanced/experiment6_final_token")
    parser.add_argument("--out_json", type=str, default="runs/balanced/experiment7_neurons_ft/neurons_report.json")
    ...
    print(f"Analyzing {len(model_paths)} Final Token models from {model_dir}...")
    ...
    print(f"Neuron report (Final Token) saved to {out_path}")
    for label in DIRS:
