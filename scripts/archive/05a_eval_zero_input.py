...
def main():
    ...
    # === ZERO-INPUT TRANSFORMATION ===
    # Replace all texts with an empty string. The model will only see the query tokens.
    for r in rows:
        r["text"] = ""
    ...
    print(f"Extracting activations for layer {args.layer_idx} (ZERO-INPUT)...")
    ...
    print(f"\n[Zero-Input Overall] Macro F1: {macro_f1:.4f}")
